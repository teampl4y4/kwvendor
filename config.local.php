...
$config['db_name'] = 'kw_vendor_marketplace';
$config['db_user'] = 'root';
$config['db_password'] = 'Josh0602';
...
$config['http_host'] = 'marketplace.dev';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'marketplace.dev';
$config['https_path'] = '';
